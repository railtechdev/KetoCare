...
class MedicationFrequency(enum.StrEnum):
    ...
    почасовые (Q1H, Q2H, Q3H, Q4H, Q6H, Q8H): для схемы противоэпилептических
    препаратов это уточнение к кратности, а не другая кратность, и пишется оно
    текстом рядом. Не взяты и недельный с месячным (WK, MO): противоэпилептические
