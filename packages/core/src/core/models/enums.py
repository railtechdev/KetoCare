...
class MedicationFrequency(enum.StrEnum):
    ...
    почасовые (Q1H–Q8H): для схемы противоэпилептических препаратов это
    уточнение к кратности, а не другая кратность, и пишется оно текстом рядом.
    Не взяты и недельный с месячным (WK, MO): противоэпилептические препараты
    так не назначают, а редкая схема описывается «другой схемой» со словами.
