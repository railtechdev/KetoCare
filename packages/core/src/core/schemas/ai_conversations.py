...
#: Что видит семья, когда ответа не будет: у воркера — при отказе модели, у
#: ручки — когда задача не встала в очередь. Один текст на оба случая: для
#: человека это одно и то же событие, а пустая реплика помощника в переписке,
#: которую читает врач, — не событие вовсе.
