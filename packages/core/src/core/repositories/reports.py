...
class MedicationAdherenceRow:
    ...
    «пропущено из положенных» здесь нет: число приёмов в сутки выводимо только
    из кода кратности (ADR-0033), у записей до списка его нет, а нужен ли
    клинике этот показатель — вопрос 37 в docs/medical/OPEN_QUESTIONS.md.
    """
