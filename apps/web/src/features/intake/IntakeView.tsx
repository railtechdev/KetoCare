  ...
  const groups = [
    {
      ...
      rows: [
        ...
        //   пусто — точки отсчёта НЕТ: про частоту впервые ответили уже на
        //   терапии, и сегодняшний уровень исходным не считается (вопрос 49).
        //
        // Раньше вторые два состояния прятались одинаково, и врач не мог
        // отличить «не изменилось» от «сравнивать не с чем» — а это
        // противоположные вещи. Показать нечего только там, где семья про
        // частоту не отвечала вовсе: тогда строка уходит в общее «Не отвечено».
