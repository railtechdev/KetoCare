 ...
 * кабинете нет. `getRandomValues` есть везде, а сервер принимает видимые
 * символы ASCII без кавычки и обратной косой черты, до 255 (ADR-0035): UUID
 * там рекомендован, а не обязателен, и шестнадцатеричная запись в класс
 * укладывается.
 */
