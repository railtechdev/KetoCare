...
#: 100 до 100,5 г: ошибка того же размера ниже 100 г проходила всегда, а
#: перепутанные колонки дают расхождение в разы, не в десятые. Килоджоули
#: вместо килокалорий эта проверка не ловит вовсе — это работа `KCAL_MAX` и
#: проверки расхождения калорийности в `product_checks`.
