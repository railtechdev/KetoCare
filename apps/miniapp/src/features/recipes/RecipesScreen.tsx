  ...
  return (
    <main className="flex flex-col gap-block p-block">
      ...
      {/* НАД списком, а не под ним. Замер при ширине потока 390 px и списке из
          ...
          полосой вкладок видно 787 px — полтора экрана прокрутки до строчки,
          объясняющей, почему выдача не обновилась. У клиники рецептов десятки,
          и список растёт; сверху высота сообщения от их числа не зависит.
          Та же правка, что в карточке рецепта.
