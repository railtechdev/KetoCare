...
клиента, главная-сводка, план дня с отметками «съедено» и динамика кетонов и
веса за 30 дней. Нет пока: калькулятор, рецепты — и кнопки «Приложение» в боте:
ей нужен публичный адрес, то есть выкат Mini App.
