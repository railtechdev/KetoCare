...
чистится от контактов ([ADR-0019](docs/adr/0019-free-text-in-ai-prompts.md)). Самих задач ИИ пока нет — `parse_free_text` (п. 19), ассистент
(п. 20), сводка врачу и черновики контента (п. 21); промптов в `ai/prompts/`
тоже нет: они меняются отдельным PR с ревью человека (раздел 10.4 ТЗ).
