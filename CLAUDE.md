...
30 минут), поэтому кнопки «Приступ» в меню бота нет: она приводила в общий отбойник
«я вас не понял». Нажатие старой кнопки (клавиатура живёт на устройстве) разбирает
`seizure_not_here` — отвечает, что приступ записывается в кабинете.
