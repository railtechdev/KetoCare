...
**Осталось по п. 20:** промпт (`ai/prompts/assistant.md`, отдельным PR по
правилу 10.4), задача воркера `assistant_reply`, ручки с перепиской в
`ai_conversations` и чат в кабинете и Mini App.
