...
class Doctor(HttpUser):
    ...
    def triage(self) -> None:
        ...
        **Что эта задача НЕ доказывает.** На прогонном сиде у учётной записи
        ...
        ФОРМУ обращения; величина измерена отдельно, на когорте в 200 пациентов
        (README, «Веер сводок»): одиночное обращение 4-5 мс, полный веер около
        полусекунды ожидания врача, пакетная ручка не окупается.
        """
