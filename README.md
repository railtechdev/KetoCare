...
| [`docs/medical/OPEN_QUESTIONS.md`](docs/medical/OPEN_QUESTIONS.md) | Вопросы медицинской команде: 34 решения, которые за врача принять нельзя. Написано для врачей, без кода |
